...
public class NPCScriptManager extends AbstractScriptManager {
    ...
    public final void startMapScript(final MapleClient c, final int npc, final String scriptName, boolean firstUser) {
        ...
        try {
            ...
            System.err.println("Error map ID : map/" + type + scriptName + ".js" + e);
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log, "Error map ID : map/" + type + scriptName + ".js" + e);
            dispose(c);
        } finally {
            lock.unlock();
        }
    ...
    public final void startItemScript(final MapleClient c, final int npc, final String item) {
        ...
        try {
            ...
            System.err.println("Error item ID : " + item + ".js" + e);
            FileoutputUtil.log(FileoutputUtil.ScriptEx_Log, "Error item ID : " + item + ".js" + e);
            dispose(c);
        } finally {
            lock.unlock();
        }
