...
public class MapleTrade {
    ...
    public static final void startCashTrade(final MapleCharacter c) {
        if (c.getTrade() == null) {
            ...
            c.getClient().getSession().write(MaplePacketCreator.serverNotice(5, "Currently in transaction."));
        }
    }
    ...
    public static final void visitTrade(final MapleCharacter c1, final MapleCharacter c2) {
	    ...
	    c1.getTrade().inTrade = true;
            ...
            c1.dropMessage(-2, "[Tip] : When conducting transactions, please pay attention to the classification of items.");
            c1.dropMessage(-2, "[Tip] : When trading maple coins, please pay attention to the handling fee.");
            c2.dropMessage(-2, "[Tip] : When conducting transactions, please pay attention to the classification of items.");
            c2.dropMessage(-2, "[Tip] : When trading maple coins, please pay attention to the handling fee.");
        } else {
            c1.getClient().getSession().write(MaplePacketCreator.serverNotice(5, "This transaction has been cancelled."));
        }
    }
    ...
    public static final void declineTrade(final MapleCharacter c) {
		...
		if (other != null && other.getTrade() != null) {
                    ...
                    other.setTrade(null);
                    other.dropMessage(5, c.getName() + " The transaction request has been rejected.");
		}
            }
