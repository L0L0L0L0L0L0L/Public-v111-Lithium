        ...
        switch (sourceid) {
            ...
            case 5320007: {//dice
                ...
                if (doublediceid > 0) {
                    ...
                    if (rand1 == 1 && rand2 == 1) {
                        applyto.dropMessage(5, "Lucky Dice Points [" + rand2 + "], [" + rand1 + "] No effect received.");
                        return;
                    } else if (rand1 == 1) {
                        applyto.dropMessage(5, "Lucky Dice Points [" + rand2 + "] Obtain random blessings.");
                    } else if (rand2 == 1) {
                        applyto.dropMessage(5, "Lucky Dice Points [" + rand1 + "] Obtain random blessings.");
                    } else {
                        applyto.dropMessage(5, "Lucky Dice Points [" + rand2 + "], [" + rand1 + "] Obtain random blessings.");
                    }
                    ...
                    if (diceid <= 1) {
                        applyto.dropMessage(5, "Lucky Dice Points [1] No effect received.");
                        return;
                    }
                    applyto.dropMessage(5, "Lucky Dice Points [" + diceid + "] Obtain random blessings.");
                    localstatups = new EnumMap<MapleBuffStat, Integer>(MapleBuffStat.class);
