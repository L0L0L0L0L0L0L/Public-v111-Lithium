    ...
    public final void memberLevelJobUpdate(final MapleCharacter mgc) {
        ...
        if (member != null) {
            ...
            if (old_level != mgc.getLevel()) {
                ...
                this.broadcast(MaplePacketCreator.serverNotice(5, "< family > " + mgc.getName() + "Upgrade to" + mgc.getLevel() + "Level, let's cheer for her!"), mgc.getId(), mgc.getId() == leaderid ? null : member.getPedigree());
            }
            if (old_job != mgc.getJob()) {
                ...
                this.broadcast(MaplePacketCreator.serverNotice(5, "< family > " + mgc.getName() + "Promoted to" + GameConstants.getJobName((int) mgc.getJob()) + "，Let's congratulate her."), mgc.getId(), mgc.getId() == leaderid ? null : member.getPedigree());
            }
        }
    }
