...
function allMonstersDead(eim) {
    ...
    var mapId = info[0];
    var map = eim.getMapInstance(mapId);
    eim.getChannelServer().broadcastPacket(MaplePacketCreator.serverNotice(6, "[Third Job] " + winner.getName() + " just defeated the third job advancement clone!"));
