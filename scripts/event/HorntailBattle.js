...
function monsterValue(eim, mobId) {//殺怪後觸發
	if (mobId == 8810000) {
		eim.getMapInstance(240060000).broadcastMessage(Packages.tools.packet.MaplePacketCreator.serverNotice(5, "You can continue along the channel."));
		}
	if (mobId == 8810001) {
		eim.getMapInstance(240060100).broadcastMessage(Packages.tools.packet.MaplePacketCreator.serverNotice(5, "You can continue along the channel."));
		}
