...
function BossBalrog(eim) {//刷出BOSS如果不這樣設置 無法正常顯示主體
	var map = eim.getMapInstance(105100300);
	//var mob1 = em.getMonster(8830007);//真实主体召喚怪物
	var mob1 = em.getMonster(8830010);//召喚怪物

	var mob2 = em.getMonster(8830009);//召喚怪物
	var mob3 = em.getMonster(8830013);//召喚怪物
...
function releaseLeftClaw1(eim) {//刷出左爪
	var mob2 = em.getMonster(8830008);//召喚怪物
...
function releaseLeftClaw2(eim) {//刷出消灭后的左爪
	var mob6 = em.getMonster(8830011);//召喚怪物
...
function releaserightClaw2(eim) {//刷出消灭后右爪
	var mob6 = em.getMonster(8830012);//召喚怪物
	eim.getMapInstance(105100300).spawnMonsterOnGroundBelow(mob6, new java.awt.Point(412, 258));
}
