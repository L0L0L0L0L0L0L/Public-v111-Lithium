/*
    Name: If you want to become an archer, go to the Bowman Village
    Map: Bowman Training Center
    Description: 100000201
*/
...
function start(mode, type, selection) {
    ...
    switch (status) {
        case 0:
            qm.sendNext("Hello, #h0#. I've heard plenty about you from Mai. You are interested in becoming a Bowman, right? My name is Athena Pierce, Bowman Job instructor. Nice to meet you!");
            break;
        case 1:
        ...
        case 4:
            if (selection == 1)
                qm.sendNext("Warrior... If you want to join them on their path of strength, wait for Dances with Balrog to contact you. Just keep an eye on the #bQuest Notifier on the left#k.");
            if (selection == 2)
                qm.sendNext("Magician... You want to join them on their path of magical power? Grendel the Really Old will be contacting you shortly. Just keep an eye on the #bQuest Notifier on the left#k.");
            if (selection == 4)
                qm.sendNext("Thief... The fighters in darkness, walkers of shadow. If you wish to join them on their path, Dark Lord will call upon you. Just keep an eye on the #bQuest Notifier on the left#k.");
            if (selection == 5) {
                qm.sendNext("Pirate... The flashy and boisterous brawlers. If you wish to walk their path, wait for Kyrin to call you. I will let her know. Just keep an eye on the #bQuest Notifier on the left#k.");
            }
...
function end(mode, type, selection) {
    ...
    switch (status) {
        ...
        case 1:
            ...
            qm.sendNext("Congratulations, you are now a Bowman. If you wish to learn new skills as a Bowman, open the Skill window. I gave you a bit of #bSP#k to play around with, so try learning a skill.");
            break;
        case 2:
