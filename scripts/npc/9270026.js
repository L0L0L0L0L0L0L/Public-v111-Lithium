...
function action(mode, type, selection) {
	...
	switch (status) {
		case 0:
			var chat = "Hello, I’m Cis. We have the beautiful look you’ve always desired! The first thing everyone notices about you is your eyes, and we can help you find the perfect contact lenses for you!#b";
