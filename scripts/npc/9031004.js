...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		} else if (cm.getPlayer().getProfessionLevel(92040000) > 0 || cm.getPlayer().getProfessionLevel(92010000) <= 0) {
			cm.sendOk("You cannot learn or unlearn Accessory Crafting because you already have Alchemy or you don't have Mining..");
			cm.dispose();
		} else {
