...
function action(mode, type, selection) {
    ...
    switch (status) {
        case 0:
            var chat = "Welcome to Edelstein. I am Winnie. Just have a membership card from our shop, and I can give you the skin you've always wanted! #b";
            chat += "\r\n#L1##v5153015##t5153015#";
            cm.sendSimple(chat);
            break;
        case 1:
            cm.sendStyle("Using our specialized machine, you can preview your appearance after the treatment. What kind of skin treatment would you like?", skin);
            break;
        case 2:
