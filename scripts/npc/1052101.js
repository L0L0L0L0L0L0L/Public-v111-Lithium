...
function action(mode, type, selection) {
	...
	switch (status) {
		case 0:
			var chat = "Welcome to the Corrupted City Hair Salon! I'm Andrea. With a membership card, you can enjoy our professional services. #b";
		...
		case 1:
			if (selection < 1) {
				...
				cm.sendYesNo("Would you like to use #v5150052#? Your appearance may change randomly.");
			}
			if (selection > 0) {
				...
				for (var i = 0; i < 8; i++)
					hair[i] = color + i;
				cm.sendYesNo("Would you like to use #v5151035#? Your appearance may change randomly.");
			}
			select = selection;
			break;
		case 2:
