...
//	switch (status) {
//		case 0:
//			var chat = "Hello, I am #b#p" + cm.getNpc() + "##k. I like to collect various rare items. If you have any, I am willing to exchange them for some accessories. #b";
//			var options = ["Pendant", "Face accessory", "Eye accessory", "Belt & Medal", "Ring"];
...
//		case 1:
//			if (selection == 0) {
//				var chat = "Okay, which type of pendant would you like? #b";
//				items = [1122018, 1122007, 1122001, 1122003, 1122004, 1122006, 1122002, 1122005, 1122058];
//				for (var i = 0; i < items.length; i++)
//					chat += "\r\n#L" + i + "##z" + items[i] + "##l";
//			}
//			if (selection == 1) {
//				var chat = "Okay, which type of face accessory would you like? #b";
//				items = [1012181, 1012182, 1012183, 1012184, 1012185, 1012186, 1012108, 1012109, 1012110, 1012111];
//				for (var i = 0; i < items.length; i++)
//					chat += "\r\n#L" + i + "##z" + items[i] + "##l";
//			}
//			if (selection == 2) {
//				var chat = "Okay, which type of eye accessory would you like? #b";
//				items = [1022073, 1022088, 1022103, 1022089, 1022082];
//				for (var i = 0; i < items.length; i++)
//					chat += "\r\n#L" + i + "##z" + items[i] + "##l";
//			}
//			if (selection == 3) {
//				var chat = "Hmm... these are a bit tricky. Due to my limited skills, I don’t know what I will make. Still want to try?";
//				items = [];
//				maxEqp = 0;
...
//					items[maxEqp] = x;
//				chat += "\r\n#L" + i + "##bI want to give it a try!";
//			}
//			if (selection == 4) {
//				var chat = "Okay, which type of ring would you like? #b";
