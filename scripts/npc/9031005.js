...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		} else if (cm.getPlayer().getProfessionLevel(92030000) > 0 || cm.getPlayer().getProfessionLevel(92000000) <= 0) {
			cm.sendOk("You cannot learn or unlearn Alchemy because you already have Smithing or you don't have Herbalism.");
			cm.dispose();
		} else {
